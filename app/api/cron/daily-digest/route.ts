    ...
    for (const client of clients) {
      try {
        ...
        if (!sessions || sessions.length === 0) {
          results.push({ email: user.email, skipped: 'no_activity' });
          continue;
        }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://web-analytics-axpyz75vi-krezzo.vercel.app'}/dashboard/clients" class="btn">View Full Dashboard →</a>
    </div>
