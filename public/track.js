      ...
      if (state === 'collapsed') {
        ...
        if (this.recentQuotes.length > 0) {
          ...
          var quotes = this.recentQuotes.map(function(q) {
            return '<span style="display:inline-block;padding:0 40px;white-space:nowrap;color:#000;font-weight:500;">"' + q.substring(0, 80) + (q.length > 80 ? '...' : '') + '"</span>';
          }).join('');
          ...
          quotesHTML = '<div style="flex:1;padding:0 20px;font-size:14px;color:#000;font-weight:500;">💭 Share your feedback with us</div>';
        }
